...
with(this){return _c('h3',{attrs:{"id":"proposed-class-details-feature"}},[_v("[Proposed] Class Details feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-class-details-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The proposed class details mechanism for each student will be facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ClassDetails")]),_v(". It allows for the tracking\nof an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Student")]),_v(" 's class details, such as their tutorial group, tutorial attendance, class participation, and assignment\ngrades. It will be stored as 3 separate classes to model each of the 3 different types of class details, and a tracker\nclass to act as the manager for each of the classes, with the trackers composing the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ClassDetails")]),_v(" class.")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Attendance")]),_v(" - Stores the details for a students attendance in a specific tutorial. Attendance will be stored as\na boolean value.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ClassParticipation")]),_v(" - Stores the details for a students participation in a specific tutorial. Class participation\nwill be stored as a boolean value.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Assignment")]),_v(" - Stores the details for a students assignment grades for a specific tutorial. Assignment grades will be\nstored as an integer value, with the total marks standardized to 100 marks.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Aspect: Class grades classes")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Use a class for each type of class details.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement, follows OOP principle. If we want to edit the implementation of each of the classes or\nchange the data structure / details of each instance, it can be easily done.")]),_v(" "),_c('li',[_v("Cons: May have performance issues in terms of memory usage.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Store class values as a primitive type (String or Integer).")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Will use less memory.")]),_v(" "),_c('li',[_v("Cons: We must ensure that the implementation of each individual class are correct. Implementation will be more\ncomplicated as different class detail types will require different implementations for the same operation.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Aspect: Tracker classes")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Use a tracker class for each type of class details.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement. Shared functions can be abstracted out and polymorphism can be applied.")]),_v(" "),_c('li',[_v("Cons: May have performance issues in terms of memory usage.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Store class values as an Object Array.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Will use less memory.")]),_v(" "),_c('li',[_v("Cons: Will need to implement different functions for each type of class details. Implementation will be more\ncomplicated. SLAP principle might not be able to be adhered to.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("CS2103T Teaching Assistants")]),_v(" "),_c('li',[_v("has a need to manage student information across different classes")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list students")])]),_v(" "),_c('li',[_c('p',[_v("ClassManager shows a list of students")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific student in the list")])]),_v(" "),_c('li',[_c('p',[_v("ClassManager deletes the student")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given student number is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. ClassManager shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. The given student number does not exist in the list.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. ClassManager shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Wed, 25 Oct 2023, 23:41:21 GMT+8]")])])])}
}];
